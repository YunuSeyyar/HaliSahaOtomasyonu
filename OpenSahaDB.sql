...
CREATE TABLE `cafes` (
  ...
  `Baslik` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `ekipmanlars` (
  ...
  `SahaId` int NOT NULL,
  `Baslik` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Resim` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Aciklama` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Ucret` double NOT NULL,
...
CREATE TABLE `eslesmes` (
  ...
  `Sahalar` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `MacTarihi` datetime(6) NOT NULL,
  `OlusturmaTarihi` datetime(6) NOT NULL,
  `AktifSure` datetime(6) NOT NULL,
  `OnayDurum` int NOT NULL DEFAULT '1',
  `YoneticiId` int NOT NULL,
  `Act` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`Id`),
...
CREATE TABLE `ilcelistes` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `IlceAdi` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `kullanicipuanislemleris` (
  ...
  `IslemTipi` int NOT NULL DEFAULT '0',
  `Ucret` double NOT NULL,
  `Puan` double DEFAULT NULL,
  `OdemeTipi` int NOT NULL DEFAULT '0',
...
CREATE TABLE `kullanicis` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `Isim` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Soyisim` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Telefon` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `odemes` (
  ...
  `RezervasyonId` int NOT NULL,
  `OdemeTipleri` int NOT NULL DEFAULT '0',
  `SahaId` int NOT NULL,
  `YoneticiId` int DEFAULT NULL,
  `Act` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`Id`),
...
CREATE TABLE `sahas` (
  ...
  `Ozellik` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Ucret` double NOT NULL,
  `YoneticiId` int NOT NULL,
...
CREATE TABLE `sehirlistes` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `SehirAdi` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sliders` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `Resim1` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Resim2` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `Yazi` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ButonYazi` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ButonLink` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `YoneticiId` int NOT NULL,
  `Act` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`Id`),
...
-- Dump completed on 2023-05-02 16:08:00
